    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <p class="small text-muted mb-1"> {{$data->stores ? $data->stores->store_name : ''}}</p>
                </td>
				<td>
                    <p class="small text-dark mb-1">{{$data->users ? $data->users->name : ''}}</p>
                </td>
				<td>
                    <p class="small text-muted mb-0">{{$data->users ? $data->users->mobile : ''}}</p>
                </td>
                <td>
                    <p class="small text-muted mb-1"> {{$data->order_type}}</p>
                </td>
                <td>
