    ...
    <table class="table" id="example5">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <p class="small text-dark mb-1">{{$item->distributor_name}}</p></td>
                  <td>  <p class="small text-muted mb-0">{{$item->users ? $item->users->mobile : ''}}</p>
...
<script>
    function htmlToCSV() {
        ...
        data.push("SRNO,OrderNo,DistributorName,DistributorContact,Amount,OrderTime");
