                ...
                <div class="card-body">
                    ...
                    <div class="search__filter">
                        <div class="row align-items-center justify-content-between">
                            <div class="col">
                                <ul>
                                    <li class="active"><a href="{{ route('admin.collection.index') }}">All <span class="count">({{$data->total()}})</span></a></li>
                                    @php
                            ...
                            <div class="col-auto">
                            <a href="{{ route('admin.collection.index',['export_all'=>'true']) }}"  class="btn btn-outline-danger btn-sm float-right"><i class="fa fa-cloud-download"></i> CSV Export</a></div>
                        </div>
                    </div>
