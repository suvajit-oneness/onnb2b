    ...
    <div class="container">
        <div class="row">
            <div class="col-12 mb-4">
                ...
                <h5 class="text-muted mb-0">{{$userTypeDetail}}</h5>
            </div>
        </div>
                    ...
                    <div class="card dashboard-card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-clipboard"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/></svg>
                                <div class="texts ml-2">
                                    <h5 class="card-title m-0">Store report</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card dashboard-card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-clipboard"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/></svg>
                                <div class="texts ml-2">
                                    <h5 class="card-title m-0">Product report</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tbody>
											...
											@if($distributor->distributor_name == null) @continue @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="amount">
                                                            {{-- Rs {{ ($report[0]->amount == null) ? 0 : number_format($report[0]->amount) }} --}} 0
                                                        </p>
                                                    </td>
                                                </tr>
                                            @endforeach
